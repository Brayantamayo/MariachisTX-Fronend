...
import { User as UserIcon, Mail, Lock, Phone, MapPin, Calendar, Hash, Music, Briefcase, Camera } from 'lucide-react';
...
export const UserForm: React.FC<Props> = ({ formData, onChange, onImageUpload, onSubmit, showPasswordFields = false }) => {
  return (
